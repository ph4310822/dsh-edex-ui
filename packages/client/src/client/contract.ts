...
import type {
  TerminalCloseRequest, TerminalOpenRequest, TerminalOpenResult, TerminalReadRequest,
  TerminalReadResult, TerminalSignalRequest, TerminalWriteRequest,
} from '@deepseek-ai/dsh-host-terminal-bridge/types'
...
export interface TerminalAssistantData {
  ...
  readonly tools: readonly { readonly callId: string; readonly name: string }[]
...
export const IDLE_PTY_STATUS: PtyStatus = { id: null, state: 'idle', error: null }
