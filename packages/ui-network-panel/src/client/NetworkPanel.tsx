...
import type { NetworkSnapshot, NetworkPanelInjected } from './index.ts'
import css from './NetworkPanel.module.css'

export type NetworkPanelProps = InjectFace<NetworkPanelInjected>
...
export function NetworkPanel({ useNetwork }: NetworkPanelProps) {
  ...
  return (
    <aside className={css.panel} data-testid="network-panel">
