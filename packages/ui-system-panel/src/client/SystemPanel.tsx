...
import type { PanelSnapshot, SystemPanelInjected } from './index.ts'
import css from './SystemPanel.module.css'

/** Full composed props of the panel entry (the panel is not localized). */
export type SystemPanelProps = InjectFace<SystemPanelInjected>
...
export function SystemPanel({ usePanel }: SystemPanelProps) {
  ...
  return (
    <aside className={css.panel} data-testid="system-panel">
      {/* ── clock & system specs ── */}
      <section className={css.section}>
        <div className={css.clock} data-testid="system-panel-clock">{clockText(now)}</div>
      ...
      <section className={css.section}>
        ...
        <div className={css.memBlock}>
          <div className={css.memLabel}>
            <span>USING {giBText(panel.memoryUsedGiB)} OF {giBText(panel.memoryTotalGiB)} GiB</span>
          ...
          <div className={css.memLabel}>
            <span>SWAP {giBText(panel.swapUsedGiB)} / {giBText(panel.swapTotalGiB)} GiB</span>
