...
let TerminalUIBridgeService = (() => {
    ...
    return class TerminalUIBridgeService extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _signal_decorators, { kind: "method", name: "signal", static: false, private: false, access: { has: obj => "signal" in obj, get: obj => obj.signal }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        cursors = (__runInitializers(this, _instanceExtraInitializers), new Map());
        constructor(ctx) {
        ...
        read(agent, request) {
            ...
            cursor.lastTotalLines = probe.totalLines;
            if (delta <= 0)
                return { text: '', truncated: false, exited: false };
...
export { TerminalUIBridgeService };
